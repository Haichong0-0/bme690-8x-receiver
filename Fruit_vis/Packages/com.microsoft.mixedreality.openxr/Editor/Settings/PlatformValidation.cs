    ...
    internal static class PlatformValidation
    {
        ...
        private static BuildValidationRule GenerateHL2RenderGraphRule()
        {
            return new BuildValidationRule()
            {
                ...
                CheckPredicate = () =>
                {
                    // URP dropped Render Graph compatibility mode in 6000.4:
                    // RenderGraphSettings.enableRenderCompatibilityMode is now [Obsolete],
                    // get-only, and always false. There is nothing left to check or fix,
                    // so the rule reports satisfied rather than nagging with no remedy.
#if UNITY_6000_4_OR_NEWER
                    return true;
#elif UNITY_RENDER_PIPELINES_UNIVERSAL_17
                ...
                FixIt = () =>
                {
#if !UNITY_6000_4_OR_NEWER && UNITY_RENDER_PIPELINES_UNIVERSAL_17
                    GraphicsSettings.GetRenderPipelineSettings<RenderGraphSettings>().enableRenderCompatibilityMode = true;
#endif //!UNITY_6000_4_OR_NEWER && UNITY_RENDER_PIPELINES_UNIVERSAL_17
                },
